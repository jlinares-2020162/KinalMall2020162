...
public class Locales {
    ...
    public void setSaldoFavor(double saldoFavot) {
        this.saldoFavor = saldoFavot;
    }
    ...
    public void setValorAdministracion(double valordAdministracion) {
        this.valorAdministracion = valordAdministracion;
    }

    @Override
    public String toString() {
        return getCodigoLocal()+ "";
    } 
}
