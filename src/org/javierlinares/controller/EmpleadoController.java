...
import org.javierlinares.bean.Cargo;
import org.javierlinares.bean.Departamentos;
import org.javierlinares.bean.Empleado;
import org.javierlinares.bean.Horario;
...
public class EmpleadoController implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        fechaContratacion.getStylesheets().add("/org/javierlinares/resource/DatePicker.css");
        cargarDatos(); 
    }
    ...
    public void guardar(){
        if (txtNombreEmpleado.getText().isEmpty() & txtApellidoEmpleado.getText().isEmpty()  & txtCorreoElectronico.getText().isEmpty()
            & txtTelefonoEmpleado.getText().isEmpty()  & txtSueldo.getText().isEmpty())JOptionPane.showMessageDialog(null, "Por favor No deje datos en blanco");
        else{ 
    ...
    public void imprimirReporte(){
        ...
        int codE = ((Empleado)tblEmpleado.getSelectionModel().getSelectedItem()).getCodigoEmpleado();
