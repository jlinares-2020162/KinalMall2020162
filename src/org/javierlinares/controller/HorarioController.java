...
public class HorarioController implements Initializable {
    ...
    public void guardar(){
        if (txtHoraEntrada.getText().isEmpty() & txtHoraSalida.getText().isEmpty())JOptionPane.showMessageDialog(null, "Por favor No deje datos en blanco");
        else{ 
    ...
    public void eliminar(){
        switch(tipoDeOperacion){
            ...
            default:
                if(tblHorarios.getSelectionModel().getSelectedItem()!= null){
                   int respuesta = JOptionPane.showConfirmDialog(null, "¿Está seguro de eliminar el registro?","Eliminar Horaios", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
